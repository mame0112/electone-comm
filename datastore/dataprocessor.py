...
class DatastoreProcessor():
    ...
    def convert_entity_to_contentdata(self, entity):
        ...
        builder.set_song_id(entity[dbconsts.SONG.SONG_ID]).set_title(entity[dbconsts.SONG.REP_TITLE]).set_description(entity[dbconsts.SONG.REP_DESCRIPTION]).set_publish_date(entity[dbconsts.SONG.REP_PUBLISH_DATE]).set_thumbnail_url(
